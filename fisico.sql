CREATE TABLE clientes (
    ...
    active VARCHAR2(5) DEFAULT 'TRUE' CHECK (active IN ('TRUE', 'FALSE')) NOT NULL,
    confirmed_email VARCHAR2(5) DEFAULT 'TRUE' CHECK (confirmed_email IN ('TRUE', 'FALSE')) NOT NULL,
