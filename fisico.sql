CREATE TABLE clientes (
    id_cliente NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY, -- autoincremental y clave primaria
    id_nacional NUMBER NOT NULL UNIQUE, -- unique para que no se repita
